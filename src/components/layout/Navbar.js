...
const Navbar = (
        ...
        const authUserLinks = (
            <Fragment>
                <Link className="nav-logo" to="/appointment" style={{textDecoration:"none", fontWeight:"bold"}}>
                DocCure &nbsp;<img className="nav-log-img" style={{width: "3.2rem"}} src={logo} />       
                </Link>
        ...
        const authDoctorLinks = (
            <Fragment>
                <Link className="nav-logo" to="/dashboard" style={{textDecoration:"none", fontWeight:"bold"}}>
                DocCure &nbsp;<img className="nav-log-img" style={{width: "3.2rem"}} src={logo} />       
                </Link>
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
                aria-label="Toggle navigation">
        ...
        const guestLinks = (
            <Fragment>
                <Link className="nav-logo" to="/" style={{textDecoration:"none", fontWeight:"bold"}}>
                    DocCure &nbsp;<img className="nav-log-img" style={{width: "3.2rem"}} src={logo} />       
                </Link>
                <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false"
                aria-label="Toggle navigation">
                ...
                <ul className="navbar-nav ml-auto" style={{color:"black"}}>
                    ...
                    <li className="nav-item dropdown active px-2">
                            <Link className="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Log in
                            </Link>
                            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    return (
        <nav className="main navbar sticky-top navbar-expand-sm navbar-dark mb-3" style={{backgroundColor:'white'}}>
