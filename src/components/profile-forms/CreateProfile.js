...
const CreateProfile = ({ createProfile, history}) => {
    ...
    return (
        <Fragment>
            <section id="Login">
                <div className="container" style={{paddingTop:"3vw", paddingBottom:"5vw"}}>
                    <div style={{height: "auto", marginLeft:"-10vw"}} class="common-form">
                        <div className="form-side">
                            <div className="heading-common">
                                <h2><strong>Add Profile</strong>
                            ...
                            <form onSubmit={e => onSubmit(e)}>
                                ...
                                <div className="form-group">
                                    <textarea 
                                        ...
                                        onChange={e => onChange(e)} required
                                    />
                                    <small  style={{color:"white"}} className="form-text">Tell us a little about yourself</small>
                                </div>
